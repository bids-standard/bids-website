...
Below are some examples of BIDS datasets that contain empty (example) raw data files. These examples 
are separated by modality and can assist you in converting your own dataset into a BIDS compliant 
dataset. 
