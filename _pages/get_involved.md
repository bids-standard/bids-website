...
| [BEP018](https://bids.neuroimaging.io/bep018){:target:"_blank"} | Genetic information                                                                                        | Cyril R Pernet, Clara Moreau, and Thomas Nichols              | Submitted a [pull request](https://github.com/bids-standard/bids-specification/pull/287){:target:"_blank"} for review.                                                                                                                    | None.                                                                                  |
