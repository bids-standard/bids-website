...
| [BEP035](https://bids.neuroimaging.io/bep035){:target:"_blank"} | Extended derivatives structure for individual-level meta-analyses based on non-BIDS compliant datasets     | Giuseppe Gallitto, Balint Kincses, and Tamas Spisak              | New BEP, collecting comments and community feedback, especially on handling "conditions-of-interests". Collaborators with mega-analysis experience or with actual example use-cases (planned/ongoing/finished mega analyses) welcome! | None.                                           |
