...
| [BEP035](https://bids.neuroimaging.io/bep035){:target:"_blank"} | Modular extensions for individual participant data mega-analyses with non-compliant derivatives   | Giuseppe Gallitto, Balint Kincses, and Tamas Spisak              | BEP revised: now collecting further comments and community feedback. Collaborators with mega-analysis experience or with actual example use-cases (planned/ongoing/finished mega analyses) welcome! | None.                                           |
| [BEP036](https://bids.neuroimaging.io/bep036){:target:"_blank"} | Phenotypic Data Guidelines   | [Eric Earl](mailto:eric.earl@nih.gov) and [Samuel Guay](mailto:samuel.guay@umontreal.ca)        | BEP drafted. Poster presentation at OHBM 2022. Now collecting community comments and feedback. All collaborators are welcome. | More reviews and discussions are necessary.   |
| [BEP037](https://bids.neuroimaging.io/bep037){:target:"_blank"} | Non-Invasive Brain Stimulation (NIBS)   | [Giacomo Bertazzoli](mailto:giacomo.bertazzoli@unitn.it), [Vittorio Iacovella](mailto:vittorio.iacovella@unitn.it), [Carlo Miniussi](mailto:carlo.miniussi@unitn.it) and [Marta Bortoletto](mailto:marta.bortoletto@cognitiveneuroscience.it) | New BEP, collecting community comments and feedback. All collaborators are welcome. | None |
