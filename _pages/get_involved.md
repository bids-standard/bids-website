...
| [BEP034](https://bids.neuroimaging.io/bep034){:target:"_blank"} | Computational modeling                                                                                     | Michael Schirner and Petra Ritter                                |  | None.                                           |
| [BEP035](https://bids.neuroimaging.io/bep035){:target:"_blank"} | Extended derivatives structure for individual-level meta-analyses based on non-BIDS compliant datasets     | Giuseppe Gallitto, Balint Kincses, Christian Büchel, Ulrike Bingel, Tor Wager, and Tamas Spisak |  | None.                                           |
