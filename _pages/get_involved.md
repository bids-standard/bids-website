...
| [BEP011](https://bids.neuroimaging.io/bep011){:target:"_blank"} | The structural preprocessing derivatives                                                                   | Andrew Hoopes                                                 | Opened the [pull request](https://github.com/bids-standard/bids-specification/pull/518){:target:"_blank"}. Need to conform with final Common Derivatives and gather community feedback. | None.                                                                                  |
...
| [BEP025](https://bids.neuroimaging.io/bep025){:target:"_blank"} | Medical Imaging Data structure (MIDS)                                                                      | Jose Manuel Saborit Torres, Maria de la Iglesia Vayá          | BEP update. Preparing to submit the preprint. Recently [published a preprint](https://arxiv.org/abs/2006.01174){:target:"_blank"} describing a use case of this BEP.                                                                                                                | None.                                                                                  |
