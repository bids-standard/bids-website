...
| [BEP035](https://bids.neuroimaging.io/bep035){:target:"_blank"} | Extended derivatives structure for individual-level meta-analyses based on non-BIDS compliant datasets     | Giuseppe Gallitto and Tamas Spisak                               |  | None.                                           |
